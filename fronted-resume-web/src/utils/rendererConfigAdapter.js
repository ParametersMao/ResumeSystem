 ...
 * @returns 适配后的配置
 */
export function adaptBasicRendererConfig(section, styleConfig) {
 ...
 * @returns 适配后的配置
 */
export function adaptEducationRendererConfig(section, styleConfig) {
    const config = section.config || {};
    const moduleConfig = styleConfig?.moduleConfig || {};
    return {
 ...
 * @returns 适配后的配置
 */
export function adaptExperienceRendererConfig(section, styleConfig) {
    const config = section.config || {};
    const moduleConfig = styleConfig?.moduleConfig || {};
    return {
        layout: config.layout || moduleConfig.layout || 'timeline',
 ...
 * @returns 适配后的配置
 */
export function adaptSkillsRendererConfig(section, styleConfig) {
    const config = section.config || {};
    const moduleConfig = styleConfig?.moduleConfig || {};
    return {
 ...
 * @returns 适配后的配置
 */
export function adaptProjectsRendererConfig(section, styleConfig) {
    const config = section.config || {};
    const moduleConfig = styleConfig?.moduleConfig || {};
    return {
        layout: config.layout || moduleConfig.layout || 'timeline',
 ...
 * @returns 适配后的配置
 */
export function adaptGenericRendererConfig(section, styleConfig) {
    const config = section.config || {};
    const moduleConfig = styleConfig?.moduleConfig || {};
    return {
 ...
 * @returns 适配后的配置
 */
export function adaptRendererConfig(section, styleConfig) {
 ...
 * @returns 适配后的样式配置
 */
export function adaptStyleConfigForRenderer(styleConfig) {
    if (!styleConfig)
        return {};
    // 提取所有样式相关的配置
    const adapted = {};
