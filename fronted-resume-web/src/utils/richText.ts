import type { ResumeSection, RichTextValue } from '@/types/resume'
...
export function normalizeRichTextValue(value: any): RichTextValue {
  if (!value) {
...
export function normalizeSectionRichText(section: ResumeSection): ResumeSection {
