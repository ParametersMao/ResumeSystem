export const CORE_SECTION_DEFINITIONS = [
    {
        type: 'intention',
        title: '求职意向',
        allowMultiple: false,
...
export const DEFAULT_CORE_THEME = {
    primaryColor: '#2563eb',
...
export function createSection(type, index) {
...
export function createDemoDocument(themeOverrides) {
...
export function ensureAllSections(document) {
...
export function extractThemeFromTemplate(templateData) {
...
export function parseResumeContent(rawContent) {
...
export function mergeResumeTheme(templateTheme, themeOverrides, fallbackTheme) {
    return {
        ...DEFAULT_CORE_THEME,
...
function normalizeThemePatch(theme) {
...
function getSourceDocument(parsed) {
...
function normalizeProfile(profile) {
    ...
    const basic = typeof source.basic === 'object' && source.basic ? source.basic : source;
    const contacts = typeof basic.contacts === 'object' && basic.contacts ? basic.contacts : {};
    return {
...
function normalizeDuration(duration, start, end) {
