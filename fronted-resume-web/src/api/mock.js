const sampleCover = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAFAAAABQCAYAAACe+1KqAAAACXBIWXMAAAsSAAALEgHS3X78AAAAJElEQVR4nO3BMQEAAADCoPdPbQ8HFAAAAAAAAAAAAAAAAAAAAAAAwKkG3AEAAn6gqZQAAAAASUVORK5CYII=';
...
function createInitialResume(resumeId, templateId) {
    return {
        resumeId,
        userId: 'u_1',
        templateId,
        ...
        sections: [
            { id: crypto.randomUUID(), type: 'summary', title: '个人简介', visible: true, items: [{ type: 'summary', content: '三年+前端开发经验，熟悉 Vue3/TypeScript。' }] },
            { id: crypto.randomUUID(), type: 'work', title: '工作经历', visible: true, items: [{ type: 'work', company: '示例公司', role: '前端工程师', start: '2022-01', end: '2023-12', highlights: ['负责在线简历编辑器重构', '引入 Vite 构建，性能提升'] }] }
        ]
    };
}
